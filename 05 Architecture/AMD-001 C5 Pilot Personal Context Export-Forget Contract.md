...
title: AMD-001 — C5 Pilot Personal Context Export/Forget Contract
aliases:
  - AMD-001
...
- AMD-001 v0.6 не является полным механизмом реализации прав субъекта по 152-ФЗ.
- AMD-001 v0.6 не является формальным ответом по статье 14 152-ФЗ.
...
(OP6 / account-deletion track) that conflicts with the narrow AMD-001 pilot
...
| Customer profile button «Удалить все мои данные» triggers OP6 | `2026-05-18-customer-first-time-handoff.md` §12 F4 | AMD-001 is not exhaustive deletion / account deletion | Owner / Product / Legal |
...
All 16 owner-provided handoff files were reviewed against the AMD-001 pilot boundary.
...
| Handoff file | Reviewed fully | Relevant personal-data classes/data | Inclusion decision | Direct source sections | Conflict with AMD-001 pilot scope | Owner action |
|---|---|---|---|---|---|---|
...
| `2026-05-17-salon-onboarding-handoff.md` | yes | Tenant admin identity, YClients credentials, KB documents, billing | `not_applicable_to_customer_pilot` | §8 Data retention | none | Govern tenant-admin data under tenant-data governance, not AMD-001. |
...
| `2026-05-19-master-device-reauth-handoff.md` | yes | `MasterSession`, `MasterRecoveryAttempt`, phone/MAX binding, earnings, audit | `excluded_post_pilot_inventory` | §9.1 `DELETED` state, §6.4 retention, §2.5 | Account-lock state machine `DELETED` terminal state conflicts with AMD-001 scope | Reclassify `DELETED` transition as OP6 / account-deletion track. |
...
| `2026-05-18-customer-first-time-handoff.md` | yes | Customer profile, preferences, visits, feedback, dispatch logs, phone, location, attachments | `excluded_post_pilot_inventory` | §12 F4, §15 `data-deletion-request` | «Удалить все мои данные» button triggers OP6 customer-deletion workflow; conflicts with narrow pilot | Reconcile F4 button copy with AMD-001 scope: restrict label to pilot-covered classes or expand inventory before shipping. |
| `2026-05-19-master-substitution-handoff.md` | yes | Substitution records, customer preferences/allergies, wellness profile, AI memory, reviews | `not_applicable_to_customer_pilot` | §2.12, §5.3, §5.6 | none | No AMD-001 delta; ensure substitution records are covered by OP6 inventory. |
...
| `2026-05-19-master-offboarding-handoff.md` | yes | Master data, customer-master AI memory, reviews, wellness profile | `excluded_post_pilot_inventory` | §2.2, §2.3, §6.4, §7.1/§7.3/§7.5 | none | Confirm customer-master `MemoryEntry` revocation semantics are compatible with AMD-001 green `MemoryEntry` lifecycle. |
...
- `contract_version` — AMD-001 version string (e.g., `"0.8.1"`);
    ...
    "consents": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "legacy_record": {
            "type": "boolean",
            "description": "true if this record was backfilled from pre-AMD001 storage and may carry sentinel values"
          },
          "schema_complete": {
            "type": "boolean",
...
- Implementation delta: AMD001-DEL-005.
...
- **Internal W3→W2 endpoint:** текущий контракт использует `{ayla_user_id}` в
  ...
  implementation gap AMD001-DEL-009: либо заменить на opaque request-scoped
...
written before activation of AMD-001 v0.6.
...
### 10.3 ConsentRecord delete semantics (AMD001-CONSENT-001)
...
| Internal W3→W2 URL with ayla_user_id | Owner feedback v0.3 | PII in URL | `implementation_delta` | W2/W3 | AMD001-DEL-009: opaque token or sanitization | no | yes |
...
| Norm / fix | Source requirement | AMD-001 section | Implementation Amendment norm ID | Evidence |
|---|---|---|---|---|
...
| Derived boundary all 3 classes | Owner ruling, P0.4 | §2 | AMD001-DER-001 | code inspection SHA `3697034f` |
| UserPersonalContext delete semantics | Owner feedback v0.3 | §3.2, §3.4 | AMD001-DEL-008 | `users/personal_data_api.py:147-152`, `users/models.py:425-544` |
| ConsentRecord retention semantics | Owner feedback v0.3 | §10.3 | AMD001-CONSENT-001 | `apps/consent/models.py:56-183` |
| Operation vs per-class state | Owner feedback v0.3 | §3.1, §3.2 | AMD001-DEL-001 | owner feedback 2026-07-23 |
| Delete barrier | Owner ruling, P0.5 | §3.3 | AMD001-DEL-001 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Hard-delete lifecycle | Owner ruling, P0.4 | §3.4 | AMD001-DEL-002 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| operation_id | Owner ruling, P1.3 | §4.1 | AMD001-DEL-003 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| scope_hash | Owner feedback v0.3 | §4.2 | AMD001-DEL-003 | owner feedback 2026-07-23 |
| Idempotency mechanics | Owner ruling, P1.4 | §4.3 | AMD001-DEL-003 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Concurrent delete joins | Owner feedback v0.3 | §4.3 | AMD001-DEL-003 | owner feedback 2026-07-23 |
| Relink abort | Owner ruling | §4.3 | AMD001-DEL-003 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Closed response schemas | Owner ruling, P1.2; owner feedback v0.3 | §5 | AMD001-DEL-004 | owner_verdict_amd020_v01_2026-07-23.md §2; owner feedback 2026-07-23 |
| Error taxonomy | Owner ruling, P1.1; owner feedback v0.3 | §5.6 | AMD001-DEL-004 | owner_verdict_amd020_v01_2026-07-23.md §2; owner feedback 2026-07-23 |
| subject_gone | Owner ruling, P1.5 | §6 | AMD001-DEL-005 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Retention manifest | Owner ruling, P0.3 | §7 | AMD001-DEL-006 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Auth/replay/step-up | Owner ruling, P0.6 | §8 | AMD001-DEL-007 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Separate idempotency/nonce/correlation | Owner feedback v0.3 | §8.1 | AMD001-DEL-007 | owner feedback 2026-07-23 |
| PII-in-URL rule | Owner feedback v0.3 | §8.3 | AMD001-DEL-009 | owner feedback 2026-07-23 |
| Secure export delivery evidence | Owner feedback v0.3 | §8.5 | — | `apps/miniapp_api/views.py:1618-1640` |
| Audit retention table | Owner ruling, P1.8 | §9 | AMD001-AUD-001 | owner_verdict_amd020_v01_2026-07-23.md §2 |
| Consent history split | Owner ruling, P1.7 | §10 | AMD001-EXP-001 | owner_verdict_amd020_v01_2026-07-23.md §2 |
...
| ConsentRecord semantics | withdraw retained | same | same | explicit AMD001-CONSENT-001 with retention/redaction | marked `proposed_norm_pending_owner_confirmation`; retention decisions open | v0.4 review |
...
| Readiness gate | minimal | 21 items | 21 items (claimed 13) | 22 items, correctly counted | 25 items; synchronized between AMD-001 and Amendment; export and backfill gates added | v0.5/v0.6 review |
...
| C4 404 ≠ semantic success | **PASS** | `subject_gone` code defined; generic 404 is treated as `upstream_error`/`contract_violation` in both AMD-001 §6 and Amendment §3/DEL-005 | §6; Amendment DEL-005 | — |
...
- Renumbered from `adr_id: AMD-020` to `adr_id: AMD-001` to resolve a duplicate
  ADR identifier in Active Canon (DRF-899).
- The `node_id` (`ayla.architecture.amd020-c5-pilot-export-forget`) and schema
  `$id` URLs retain the historical `amd020` segment for identity stability.
- The architectural decision content, status and decision status were not
  changed; the document version was bumped to 0.8.1 to record the renumber
  metadata change.
- Filename, title, aliases and internal `AMD-020`/`AMD020` references updated
  to `AMD-001`/`AMD001`.
- Related validator script and fixture directory renamed from `amd020` to
  `amd001`.
...
- Все root JSON Schemas получили `$id`; добавлен запускаемый
  `scripts/validate_amd001_schemas.py`.
...
- Readiness gates синхронизированы между AMD-001 и Amendment (25 items).
