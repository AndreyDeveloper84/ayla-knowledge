...
| Ayla Living Digital Twin Manifesto | Foundation | `00 Foundation\Ayla Living Digital Twin Manifesto.md` (планируемый) | MISSING / PHASE B OPEN | — | Phase B opened 2026-07-30. Manifesto not created yet. Initial document status after creation: DRAFT. Below Product Essence v1.1. Cannot override Product Essence. |
