...
| Ayla MVP Reset Roadmap v1.1 | Operational | `02 Strategy\Ayla MVP Reset Roadmap.md` | CANONICAL | v1.0 (Git history) | Операционный источник порядка перестройки и выпуска. v1.1 (2026-09-21) — частичная замена: §2 «Основной путь», §5 Sprint 1–4 и §7 «Минимальные новые сущности» заменены AYLA-DEC-0087, 0088, 0089, 0094, 0095, 0099 и не действуют (раздел «Заменённые разделы» в документе); остальные разделы действуют. OD-AUDIT-004 закрыт AYLA-DEC-0087. Не переопределяет Product Essence и не занимает места в иерархии между Essence и Product Vision. |
| Ayla MVP Reset Roadmap v1.0 | Operational history | Git history (тот же файл, стабильное имя) | SUPERSEDED | — | Owner approved 2026-07-29; заменён v1.1 (2026-09-21, AYLA-DEC-0087). Прежняя пометка «NO_CHANGE_REQUIRED при канонизации OD-MVP-1…4» была неверна: §2 «Основной путь» противоречил MVP User Journey v1.2 (OD-AUDIT-004). |
...
| Consent Scope Registry | Safety and Governance | `06 Safety and Governance\Consent Scope Registry.md` | CANONICAL (v1.4, approved / canonical) | — | Добавлено 2026-09-21 (DRF-2260): документ approved, но отсутствовал в реестре. Подтверждён AYLA-DEC-0081. Поправка v1.5 по AYLA-DEC-0087, 0098, 0100 — отдельным PR (DRF-2262). |
| Ayla Memory Model Specification | Architecture | `05 Architecture\Ayla Memory Model Specification.md` | CANONICAL (v1.0, approved / canonical) | — | Добавлено 2026-09-21 (DRF-2260): документ approved, но отсутствовал в реестре. |
| BOT-001 First Contact Specification | Product | `01 Product\BOT-001 First Contact Specification.md` | CANONICAL (v1.0, approved / canonical) | — | Добавлено 2026-09-21 (DRF-2260): документ approved, но отсутствовал в реестре. Открытая поправка A-1 — PR #19 (не входит в эту запись). |
| BOT-002 Conversation Lifecycle Specification | Product | `01 Product\BOT-002 Conversation Lifecycle Specification.md` | CANONICAL (v1.0, approved / canonical) | — | Добавлено 2026-09-21 (DRF-2260): документ approved, но отсутствовал в реестре. |
| Ayla Master MVP Auth and Authority Contract | Architecture | `05 Architecture\Ayla Master MVP Auth and Authority Contract.md` | CANONICAL (v1.0, approved / canonical) | — | Добавлено 2026-09-21 (DRF-2260): документ approved, но отсутствовал в реестре. Master MVP Canon Freeze — AYLA-DEC-0080. |
| Ayla MVP Customer Resolution Contract | Architecture | `05 Architecture\Ayla MVP Customer Resolution Contract.md` | CANONICAL (v1.0, approved / canonical) | — | Добавлено 2026-09-21 (DRF-2260): документ approved, но отсутствовал в реестре. Master MVP Canon Freeze — AYLA-DEC-0080. |
| Ayla Goal and Desired Outcome Contract | Architecture | `05 Architecture\Ayla Goal and Desired Outcome Contract.md` | READY_FOR_OWNER_REVIEW (v0.1, review / candidate) | — | Этап C (DRF-2261). Основание: AYLA-DEC-0087, 0090, 0094. Канонизируется после утверждения владельцем в PR. |
| Ayla Personal Plan Contract | Architecture | `05 Architecture\Ayla Personal Plan Contract.md` | READY_FOR_OWNER_REVIEW (v0.1, review / candidate) | — | Этап C (DRF-2261). Основание: AYLA-DEC-0088…0093, 0097. Машиночитаемое приложение `plan-action.schema.json`. |
| Ayla Diary and Water Contract | Architecture | `05 Architecture\Ayla Diary and Water Contract.md` | READY_FOR_OWNER_REVIEW (v0.1, review / candidate) | — | Этап C (DRF-2261). Основание: AYLA-DEC-0095, 0099, 0101. Машиночитаемое приложение `diary-day.schema.json`. |
| Ayla Dietitian Capability Contract | Architecture | `05 Architecture\Ayla Dietitian Capability Contract.md` | READY_FOR_OWNER_REVIEW (v0.1, review / candidate) | — | Этап C (DRF-2261). Основание: AYLA-DEC-0095, 0098, 0100. Constitution Ст. XII — Ayla не заменяет диетолога. |
| Ayla Decision Policy Contract | Architecture | `05 Architecture\Ayla Decision Policy Contract.md` | READY_FOR_OWNER_REVIEW (v0.1, review / candidate) | — | Этап C (DRF-2261). Основание: AYLA-DEC-0096, 0097. Машиночитаемое приложение `decision-outcome.schema.json`. Словарь reason_code — предложение, утверждает владелец. |
