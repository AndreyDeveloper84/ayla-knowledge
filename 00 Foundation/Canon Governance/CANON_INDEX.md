...
| Product Vision | Foundation | `01 Product\Ayla Product Vision.md` | PARTIALLY_ALIGNED (v1.4, review) | — | Foundation Window документ №1 (текущий). Обновлён 2026-07-27 — до Essence v1.1; LDT не отражён. D:-копии — forbidden inputs. |
| Product Thesis | Foundation | `02 Strategy\Ayla MVP Product Thesis.md` | DRAFT (v0.4) | — | Foundation Window документ №2. До Essence v1.1; LDT не отражён. |
